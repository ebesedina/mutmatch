...
#' grSNVs_chr1 <- load_mutations(mutationsPath = "example_mutations.csv.gz", chr = "1")
#' grSNVs_chr1 <- load_mutations(mutationsPath = system.file("extdata", "example_mutations.csv.gz", package = "mutmatch"), chr = "1")
#' }
